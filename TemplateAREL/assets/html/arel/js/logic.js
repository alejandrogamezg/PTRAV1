...
arel.sceneReady(function() {
    ...
    scenario.currentTrackingConfigPathOrIdentifier = "html/resources/TrackingConfig_e9c902715813e29f63535a948c78dc4f.zip";
    ...
    scenario.onStartup = function () {
        arel.Debug.log("Welcome to the 'video2' Augmented Reality experience.");
    ...
    pattern1.cosName = "10149366_717250261640620_1602016666_n_1";
    pattern1.cosID = "1";
    ...
    model1.type = "Model";
    model1.scene = scene1;
    model1.associatedTrackable = pattern2;
    ...
    video2.scene = scene1;
    video2.associatedTrackable = pattern1;
    ...
    video2.play = function () {
        ...
        if (scenario.googleAnalytics) {
            scenario.googleAnalytics.logVideo("Comparacion del Tamaño de los Planetas HD.");
        }
        if (methodExists(this, this.onPlayed)) {
            this.onPlayed();
        }
